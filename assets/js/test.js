CrosswordWidth = 19;
	CrosswordHeight = 20;
	Words = 30;
	WordLength = new Array(7, 4, 6, 8, 7, 4, 5, 4, 9, 5, 6, 7, 6, 5, 6, 6, 6, 6, 4, 7, 7, 5, 7, 6, 5, 4, 9, 6, 6, 6);
	Word = new Array("MISSION", "RISK", "GROWTH", "CREDITOR", "AUDITOR", "GOAL", "FRAUD", "BANK", "INFLATION", "LEASE", "SECTOR", "QUALITY", "BUDGET", "SALES", "VISION", "TRADER", "DEBTOR", "MARKET", "WAGE", "PREMIUM", "ACCOUNT", "BRAND", "TRUSTEE", "PROFIT", "VALUE", "LOAN", "LIQUIDITY", "CLIENT", "EQUITY", "TALENT");
	Clue = new Array("Ambition or purpose, ___ in life", 
"One cannot be sure if one takes it", 
"Gradual increase, a ___ in numbers", 
"Extremely clever newspaper man? You owe him", 
"I hear someone coming to check", 
"Intended outcome", 
"Trickery had!", 
"Check point", 
"Minister of Finance's concern", 
"First of landlords to reduce rent", 
"Division of the economy", 
"Of superior class", 
"Spending proposals", 
"\"Buy one, get one\" events", 
"Imaginative insight", 
"Merchant", 
"his account is outstanding", 
"Use an ad campaign", 
"Renumeration", 
"Insurance payment as an incentive", 
"Financial statement", 
"Trademark", 
"Have faith in notes by administrator", 
"In favour of healthy return", 
"Assessor's figure", 
"Bucks from the bank", 
"Ability to meet debts without using fixed assets", 
"Buyer has left one in the money", 
"Shares in the union", 
"Inherent skill");
	AnswerHash = new Array(36339, 6115, 40213, 61775, 42322, 80412, 8134, 22882, 92264, 40167, 34103, 4881, 87613, 37052, 45943, 79032, 78909, 15671, 86572, 33791, 32396, 44978, 66671, 39909, 84534, 30013, 15080, 8595, 15481, 86496);
	WordX = new Array(7, 7, 11, 2, 9, 1, 5, 0, 4, 14, 3, 1, 13, 8, 0, 5, 6, 7, 4, 12, 2, 9, 15, 6, 18, 11, 14, 5, 1, 9);
	WordY = new Array(0, 2, 3, 5, 6, 7, 8, 9, 10, 11, 12, 14, 14, 15, 16, 17, 19, 0, 2, 2, 4, 4, 5, 7, 7, 9, 11, 12, 13, 14);
	LastHorizontalWord = 16;
	OnlyCheckOnce = false;



// Separate of the next code
...
function HashWord(Word)
{
	...
	return Hash;
                        ...
                        // Separate code to beginthe cross word 
