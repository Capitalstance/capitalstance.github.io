...
cards.forEach(function(card) {
    card.addEventListener('click', function() {
        ...
        // Add click event listener to the "cost" button in the modal
        book.querySelector('.cost').addEventListener('click', function() {
            // Get the URL associated with the book from the 'books' array
            const url = books[+id][7]; // Assuming the URL is at index 7 in the 'books' array
            // Navigate to the URL
